...
module.exports = function (accessToken, timeout) {
     ...
     * 'api.eu1.prepr.io'.
     *
     * @param {{path: *, hostname: string, method: string}} requestParams
    ...
    // METHODS
    return {
        get: function (path, params, callback, hostname = '') {
            httpRequest({ hostname: hostname, path: path, params: params, method: 'GET' }, callback);
        },
        post: function (path, params, callback, hostname = '') {
            httpRequest({ hostname: hostname, path: path, params: params, method: 'POST' }, callback);
        },
        put: function (path, params, callback, hostname = '') {
            httpRequest({ hostname: hostname, path: path, params: params, method: 'PUT' }, callback);
        }
    };
};
